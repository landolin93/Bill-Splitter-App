                        ...
                        {(() => {
                          ...
                          return (
                            <>
                              ...
                              <div className="flex justify-between">
                                <span>Tax <span className="italic text-gray-600">({costs.taxRate.toFixed(1)}%):</span></span>
                                <span>${costs.tax.toFixed(2)}</span>
                              </div>
                              <div className="flex justify-between">
                                <span>Tip <span className="italic text-gray-600">({costs.tipRate.toFixed(1)}%):</span></span>
